...
var animate = function () {
    ...
    animate.prototype.start = function (settings) {
        ...
        var _prms = new Promise(function (resolve, reject) {
            // get the element
            var elem = document.getElementById(settings.elem);
            // create the style string
            var styleString = _.join(_.map(settings.properties, function (o, key) {
                return _.join([key, o], ':');
            }), ';');
